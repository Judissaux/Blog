...
{   
    ...
    // fonction pour cacher le type dans les réglages généraux
    ...
    {
        return $crud
        //Permet de s'assurer que ce CRUDCONTROLLER est accéssible quand on est administrateur        
            ->setEntityPermission('ROLE_ADMIN')
        //Permet de cacher le champs de recherche qui se situe en haut de page
            ->setSearchFields(null)
        // Change le label de la page
            ->setEntityLabelInPlural('Réglages généraux')
        // Permet d'avoir les actions directement sans avoir les ...
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        //Permet d'empêcher de modifier le label
         ->setFormTypeOption('attr', [
            'readonly' => true
         ]);

         yield TextField::new('value', 'Valeur');
         // Le hiddenfields permets de cacher cette élément lorsque l'on veut éditer l'option
